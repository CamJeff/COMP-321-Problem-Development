...
The first line contains two integers $M$ and $N$, representing the minimum number of points required for full marks and the number of available problems on this assignment, where $1\leq N\leq 20$, and $1\leq M\leq 10^{15}$.
